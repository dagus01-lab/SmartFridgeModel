...
from detector.cfg import TASK2DATA, get_cfg, get_save_dir
from detector.hub.utils import HUB_WEB_ROOT
from detector.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
...
class Model(nn.Module):
    ...
    def _get_hub_session(model: str):
        ...
        from detector.hub.session import HUBTrainingSession
    ...
    def track(
        ...
        **kwargs,
        ...
        if not hasattr(self.predictor, "trackers"):
            from detector.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        """
        self._check_is_pytorch_model()
        from detector.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from detector.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        """
        from detector.nn.autobackend import check_class_names
